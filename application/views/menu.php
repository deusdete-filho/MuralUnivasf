      ...
      <header class="header header-inverse">
        <div class="container">
          <div class="header-info">
            <div class="left">
              <h2 class="header-title"><strong>Bem Vindos</strong> </h2>
            </div>
            <div class="right flex-middle d-none d-md-block">
              <form class="lookup lookup-circle lookup-lg lookup-right" action="<?=base_url();?>dasboard/pesquisar" method="post">
